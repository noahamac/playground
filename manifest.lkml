...
visualization: {
  ...
  file: "metrics.js"
  label: "Metrics"
  dependencies: ["https://cdnjs.cloudflare.com/ajax/libs/metrics-graphics/2.15.6/metricsgraphics.min.js", "https://cdnjs.cloudflare.com/ajax/libs/d3/4.0.0/d3.min.js"]
}
